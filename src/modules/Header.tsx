    ...
    return (
        <div className="mt-3 px-32 flex items-center justify-between text-sm text-black">
            ...
            <div className="flex items-center gap-7">
                <LanguageSelect />
                <button className=" relative bg-black text-white px-5 flex items-center gap-2 py-2 rounded-lg text-xs font-semibold cursor-pointer transition-all duration-300 ease-out overflow-hidden hover:scale-105 hover:shadow-lg hover:bg-gray-900 active:scale-95 ">
