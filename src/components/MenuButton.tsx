...
const MenuButton = ({ title, href = "#" }: MenuButtonProps) => {
    return (
        <Link href={href} className="relative inline-flex items-center gap-3 bg-black text-white px-5 py-5 rounded-t-2xl rounded-bl-2xl font-bold text-lg overflow-hidden transition-all duration-300 ease-out hover:scale-105 hover:shadow-2xl hover:shadow-black/30 active:scale-95 group " >
